...
public abstract class MessageRouter {
	...
	private HashMap<String, Message> messages;
        //em teste - armazena o buffer
        public HashMap<String, Message> buffer;
	...
	protected Message getMessage(String id) {
        ...
        //em teste
        public Message getMessageBuffer(String id) {
	...
	protected boolean hasMessage(String id) {
        ...
        //em teste
        public boolean hasMessageBuffer(String id) {
	...
	public Collection<Message> getMessageCollection() {
        ...
        //em teste
        public Collection<Message> getMessageIncomingCollection() {
            return this.incomingMessages.values();
        }

        //em teste - pega as mensagens do nosso buffer
        public Collection<Message> getMessageBufferCollection() {
	...
	public int getNrofMessages() {
        ...
        //em teste
        public int getNrofMessagesBuffer() {
	...
	protected void addToMessages(Message m, boolean newMessage) {
		this.messages.put(m.getId(), m);
                //em teste
                this.buffer.put(m.getId(), m);
                //System.out.println("Mensagem "+m.getId()+" criada em: " +m.getFrom());
                //System.out.println("Buffer de "+messagesInBuffer(m));
		if (newMessage) {
			for (MessageListener ml : this.mListeners) {
				ml.newMessage(m);
			}
        ...
        //em teste
        /*public  messagesInBuffer(Message m) {
	...
	protected Message removeFromMessages(String id) {
		Message m = this.messages.remove(id);
                //em teste
                Message m2 = this.buffer.remove(id);
		return m;
